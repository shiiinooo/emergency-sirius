...
gold_dag = DAG(
    ...
    description='A DAG to aggregate and enrich temps calls data for final use (Gold Layer)',
...
run_spark_job_script_task = BashOperator(
    ...
    bash_command=(
        'ssh hadoop@192.168.4.50 "bash /opt/hadoop/scripts/temps_attente/spark_job.sh"'
    ),
    dag=gold_dag,
)
